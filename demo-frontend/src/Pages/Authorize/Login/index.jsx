  ...
  return (
    <Fragment>
      ...
      <Card
        ...
        style={{
          width: 800,
          boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', // Apply shadow here
        }}
...
>
          ...
          <Form.Item name="Password" style={{marginBottom:40}} rules={[
            {
              required: true,
          ...
          <Button size="large" type="primary" htmlType="submit" style={{width:"100%",backgroundColor:"#333399"}}>Đăng nhập</Button>
        </Form>
        </div>
        <div style={{width:"55%"}}>
